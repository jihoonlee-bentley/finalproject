...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 10 15:59:28 2022
...
productlinks=[]
for x in range(1,11):
    r = requests.get(f'https://shop.blanchards.net/s-10165/c-2/buy-liquor?catId=2&typeId=14&pageNumber={x}')
