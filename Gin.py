...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 10 16:05:10 2022
...
productlinks=[]
for x in range(1,8):
    r = requests.get(f'https://shop.blanchards.net/s-10165/c-2/buy-liquor?catId=2&typeId=16&pageNumber={x}')
